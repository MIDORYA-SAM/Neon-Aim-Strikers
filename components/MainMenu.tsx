    ...
    <div className="absolute inset-0 z-30 flex flex-col items-center justify-center bg-black/60 backdrop-blur-xl">
      <div className="text-center space-y-6 max-w-2xl px-4">
        ...
        <p className="text-xl text-gray-400 font-light tracking-widest uppercase">
          Neural Uplink Estabelecido // Treinador de Mira v3.0
        </p>
        ...
        <div className="grid grid-cols-3 gap-4 py-4">
          <div className="bg-white/5 p-4 border border-cyan-500/30 rounded-lg">
            ...
            <p className="text-[10px] text-gray-500">Alvos rápidos. Mantenha o ritmo.</p>
          </div>
          <div className="bg-white/5 p-4 border border-yellow-500/30 rounded-lg">
            ...
            <p className="text-[10px] text-gray-500">Alto valor. Janela de tempo curta.</p>
          </div>
          <div className="bg-white/5 p-4 border border-red-500/30 rounded-lg">
            ...
            <p className="text-[10px] text-gray-500">Não atire. Penalidade instantânea.</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 text-xs text-gray-600 font-mono">
           <span>CONEXÃO_CRIPTOGRAFADA: SEGURA</span>
           <span className="w-1 h-1 bg-gray-600 rounded-full"></span>
           <span>LOC_SISTEMA: ESTAÇÃO_ORBITAL_IV</span>
        </div>
      </div>
    </div>
  );
